    ...
    export default function Login() {
      ...
      const handleSubmit = (e: React.FormEvent) => {
        ...
        if (email.includes('staff')) {
          toast.success('Welcome back, Maintenance Staff!');
          ...
          <div className="max-w-md w-full">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-200">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  type="submit"
                  className="w-full bg-slate-900 text-white py-3.5 rounded-xl font-bold hover:bg-slate-800 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-slate-900/20"
                >
                  Sign In
                </button>
              </form>
            ...
            <div className="mt-8 text-center">
              <p className="text-xs text-slate-400">
                Demo: Use any email with "staff" for Maintenance view.
              </p>
            </div>
          </div>
        </div>
